...
export function Sidebar({
  ...
  return (
    <aside className="sticky top-0 flex h-screen w-20 shrink-0 flex-col items-center gap-3 overflow-y-auto py-5 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
      {/* Logo */}
